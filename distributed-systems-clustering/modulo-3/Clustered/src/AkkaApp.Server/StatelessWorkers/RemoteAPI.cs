...
using AkkaApp.Server.Domain;

using static AkkaApp.Server.Domain.Genre;
using static System.TimeSpan;
namespace AkkaApp.Server.StatelessWorkers
{
    public class RemoteAPI
    {
        ...
        public async Task<IEnumerable<Video>> GetUnseenVideosAsync(IEnumerable<int> watchedVideoIds)
        {
            await Task.Yield();
